...
$query = "SELECT first_name, last_name, profile_picture FROM patients WHERE id = ?";
...
<body>
	...
	<div class="buttons">
  		<div class="choices"><p><a href="MyAccount\index.php">My Account</a></p></div>
		<div class="choices"><p><a href="Appointment\index.php">Book an Appointment</a></p></div>
		<div class="choices"><p><a href="OnlineConsultation\index.php">Online Consultation</a></p></div>
	...
	<div class="news">
		...
		$formattedDate = date("m/d/Y", strtotime($row['posted_at']));
        	...
        	echo "<p>" . nl2br(htmlspecialchars($row['content'])) . "</p>"."<br>";
        	echo "<br><br></div>";
